...
import { redirectToAuthCodeFlow, getAccessToken } from './authCodeWithPkce'; // Adjust path if needed
    ...
    <div className="account">
      {profile ? (
        <section id="profile">
          ...
          <img id="avatar" width="200" src={profile.images?.[0]?.url || 'https://via.placeholder.com/200'} alt="Profile" />
          <ul>
